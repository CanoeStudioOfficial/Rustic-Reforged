...
public class WorldGenOliveTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = ModBlocks.LOG.getDefaultState().withProperty(BlockLogRustic.VARIANT, BlockPlanksRustic.EnumType.OLIVE);
	private static final IBlockState LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(BlockLeavesRustic.VARIANT, BlockPlanksRustic.EnumType.OLIVE).withProperty(BlockLeavesRustic.CHECK_DECAY, false);
